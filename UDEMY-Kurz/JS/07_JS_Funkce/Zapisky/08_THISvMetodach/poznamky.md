**THIS keyword**
    ...
    - hodnota this závicí na kontextu volání fce. ve které je použit
    ...
    - v "globálním" kódu se this odkazuje na windows objekt -> vytvoří se vždy při otevření stránky
      -> např. jakékoli fce. co zde nadefinuji se automaticky dají použít jako metody windows objektu 
