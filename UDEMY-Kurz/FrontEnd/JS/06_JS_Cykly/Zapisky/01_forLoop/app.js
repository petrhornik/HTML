...
for (let i = 1; i <= 10; i++) {
  // mám novou prom. i, která se bude po každém provedení cyklu inkrementovat, cykl se bude provádět dokud bude po každém jeho zkončení podmínka stále platná (v našem případě i <= 10)
