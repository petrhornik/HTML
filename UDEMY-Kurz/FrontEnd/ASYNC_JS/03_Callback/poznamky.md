**Callback**
    => po vnořování více čekajících fcí, za sebe tak, aby byl kód relativně přehledný a funkce se prováděly s časovým odstupem od sebe, tak jak chceme
    ...
    -> v async operacích je ve fci. většinou více než 1 callback
